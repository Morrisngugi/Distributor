            ...
            <div class="nano-content">
              ...
              <div class="aside-nav collapse">
               <ul class="nav">
                  ...
                  <li class="active"><a href="metrics-definition.php"><span class="label label-primary">6</span><i class="icon s7-trash"></i> Metrics Definition</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <table class="table table-fw-widget">
                  <thead>
                    <tr>
                      <th>Metric Definition Code</th>
                      <th>Metric Definition Name</th>
                      <th>Description</th>
                      <th>Action</th>
                    </tr>
                  </thead>
