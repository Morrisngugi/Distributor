            ...
            <div class="nano-content">
              ...
              <div class="aside-nav collapse">
               <ul class="nav">
                  ...
                  <li class="active"><a href="custom-fields.php"><span class="label label-primary">6</span><i class="icon s7-trash"></i> Custom Fields</a></li>
